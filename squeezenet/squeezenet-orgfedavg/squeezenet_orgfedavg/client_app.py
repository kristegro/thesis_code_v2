...
from squeezenet_orgfedavg.task import load_data, set_weights, get_weights, train, test
...
class FlowerClient(NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        current_path = Path("./storage/squeezenet-orgfedavg-training-time")
    ...
    def evaluate(self, parameters, config):
        ...
        # Lag path hvis den ikke eksisterer.
        current_path = Path("./storage/squeezenet-orgfedavg-evaluation-time")
        Path.mkdir(current_path,
               mode=0o777,
               parents=True, 
               exist_ok=True)
