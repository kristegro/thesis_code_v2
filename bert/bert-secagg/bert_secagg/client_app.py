...
from bert_secagg.task import get_weights, load_data, set_weights, test, train
...
class FlowerClient(NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        current_path = Path("./storage/bert-secagg-training-time")
    ...
    def evaluate(self, parameters, config):
        ...
        # Lag path hvis den ikke eksisterer.
        current_path = Path("./storage/bert-secagg-evaluation-time")
        Path.mkdir(current_path, 
                   parents=True, 
                   exist_ok=True)
        Path.chmod(current_path, mode=0o777)
